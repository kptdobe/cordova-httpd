...
public class WebServer extends NanoHTTPD {
	...
	public WebServer(String host, int port, File wwwroot, boolean quiet) {
		super(host, port);
		this.quiet = quiet;
	...
	public WebServer(String host, int port, List<File> wwwroots, boolean quiet) {
		super(host, port);
		this.quiet = quiet;
	...
	public WebServer(InetSocketAddress localAddr, AndroidFile wwwroot) throws IOException {
		this(localAddr.getHostName(), localAddr.getPort(), wwwroot, true);
	}

	public WebServer(int port, AndroidFile wwwroot ) throws IOException {
		this("localhost", port, wwwroot, true);
	}
	...
	public static void main(String[] args) {
		...
		ServerRunner.executeInstance(new WebServer(host, port, rootDirs, quiet));
	}
